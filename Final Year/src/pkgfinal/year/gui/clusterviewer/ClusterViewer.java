...
import pkgfinal.year.gui.plot.Plot.LegendFormat;
import pkgfinal.year.patterns.cluster.Cluster;



/**
 * This is the PASD cluster viewer.
...
public class ClusterViewer extends JFrame implements ClusterViewerPanelListener{
	...
	/** Title of this panel */
	String title = "PASD Cluster Viewer 1.00";
...
//		panelTools.setBounds(0, 0, 800, 100);
		...
		buttonZoomIn.setIcon(new ImageIcon(ClusterViewer.class.getResource("/pkgfinal/year/gui/icons/zoomin.gif")));
		
		JButton buttonZoomOut = new JButton("");
		buttonZoomOut.setBounds(270, 16, 50, 29);
		panelTools.add(buttonZoomOut);
		buttonZoomOut.setIcon(new ImageIcon(ClusterViewer.class.getResource("/pkgfinal/year/gui/icons/zoomout.gif")));
		...
		buttonSaveAsPng.setIcon(new ImageIcon(ClusterViewer.class.getResource("/pkgfinal/year/gui/icons/save.gif")));
		...
		buttonPrint.setIcon(new ImageIcon(ClusterViewer.class.getResource("pkgfinal/year/gui/icons/print.gif")));
