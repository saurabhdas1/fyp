...
import pkgfinal.year.gui.plot.Plot;
import pkgfinal.year.gui.plot.Plot.Data;
import pkgfinal.year.gui.plot.Plot.LegendFormat;
import pkgfinal.year.gui.plot.Plot.Line;
import pkgfinal.year.gui.plot.Plot.Marker;
import pkgfinal.year.gui.timeseriesviewer.TimeSeriesViewerPanelListener;
...
//			System.out.println(scaleLevel);
	...
	public void doPrint() {
		...
		pj.setJobName(" PASD print time series");
