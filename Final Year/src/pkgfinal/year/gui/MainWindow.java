...
import pkgfinal.year.algorithmmanager.descriptions.DescriptionAlgoClusterViewer;
import pkgfinal.year.algorithmmanager.descriptions.DescriptionAlgoTimeSeriesViewer;
...
import pkgfinal.year.gui.patternvizualizer.PatternVizualizer;
...
/**
 * This class is the user interface of the application (the main Window).
...
public class MainWindow extends JFrame implements ThreadCompleteListener, UncaughtExceptionHandler {
    ...
    public MainWindow() throws Exception {
        ...
        setTitle("APP v" + Main.APP_VERSION);
        ...
        lblNewLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent arg0) {
            	// Show the webpage of the APP project
                openWebPage("127.0.0.1");
            }
        });
...
//                    	checkboxOpenOutputPatternViewer.setVisible(false);
                ...
                if (isVisible() == false) {
                    System.out.println("There is no algorithm with this name. "
                            + " To fix this problem, you may check the command syntax in the APP documentation"
                            + " and/or verify if there is a new version of APP on the APP website.");
                }
	...
	private void askUserToChooseInputFile() {
		try {
		    ...
		    if (previousPath == null) {
		        ...
		        // Otherwise, the user used APP before, so
