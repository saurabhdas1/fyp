...
import pkgfinal.year.input.sequence_database_array_integers.Sequence;
...
public class TransactionDatabaseConverter {
	...
	/**
	 * This method converts a transaction database from a given format to the PASD format.
	...
	public void convert(String input, String output, Formats inputFileformat, int lineCount) throws IOException {
		...
		}else if(inputFileformat.equals(Formats.PASD_SEQUENCE_DB)){
			convertSequenceDB();
		}
	...
	/**
	 * This method convert a transaction database in ARFF format to PASD format and
	...
	/**
	 * This method convert a file from the ARFF format to the PASD format.
	 * 
...
//				}
	...
	/**
	 * This method convert a file from the CSV format to the PASD format
	 */
	...
	/**
	 * This method convert a file from the PASD sequence database format 
	 * to the PASD transaction database format.
